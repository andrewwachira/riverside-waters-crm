    ...
    <div className="relative w-full max-w-142.5 rounded-lg bg-meta-3 px-8 py-12 text-center md:px-17.5 md:py-15">
        <span className="mx-auto inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="78" height="78" color="#fff" fill="none">
                ...
                <path d="M7 9C7.20949 9.5826 7.77476 10 8.43922 10C9.10367 10 9.66894 9.5826 9.87843 9M14.1216 9C14.3311 9.5826 14.8963 10 15.5608 10C16.2252 10 16.7905 9.5826 17 9" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round" strokeLinejoin="round" />
