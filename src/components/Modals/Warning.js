...
function Warning({message,onRequestClose,setConfirmDelete}) {
  return (
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126ZM12 15.75h.007v.008H12v-.008Z" />
      ...
      <div className='flex justify-around'>
        <button onClick={()=>setConfirmDelete(true)} className="inline-block rounded  px-12.5 py-3 text-center font-medium text-white transition hover:bg-white hover:text-black bg-rose-600">Yes, Delete</button>
        <button onClick={()=>onRequestClose(true)} className="inline-block rounded  px-12.5 py-3 text-center font-medium text-white transition hover:bg-white hover:text-black bg-slate-800">Cancel</button>
      </div>
