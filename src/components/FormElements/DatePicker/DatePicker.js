...
const DatePicker = ({labelName,inputName,getDatefn,Err,clearWarning}) => {
  ...
  return (
    <div>
      ...
      <div className="relative">
          <input ref={inputRef} id={inputName} name={inputName} className={`w-full rounded border-[1.5px] border-stroke bg-transparent p-5 font-normal outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${Err && "border-rose-500"}`} placeholder="mm/dd/yyyy" data-class="flatpickr-right" />
