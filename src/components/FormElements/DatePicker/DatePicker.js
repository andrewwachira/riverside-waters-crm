  ...
  useEffect(() => {
    if (inputRef.current) {
      flatpickr(inputRef.current, {
        ...
        onChange: (selectedDates, dateStr) => { getDatefn && clearWarning ? (getDatefn(dateStr, inputName),clearWarning(inputName)): getDatefn ? (getDatefn(dateStr, inputName)) :getTestDateFn && getTestDateFn(dateStr)},
